...
<template>
  <article class="group border dark:border-gray-800 m-2 rounded-2xl overflow-hidden shadow-sm text-zinc-700 dark:text-zinc-300 transition-all duration-300 hover:scale-105 hover:shadow-lg transform">
    <NuxtLink :to="path" class="grid grid-cols-1 sm:grid-cols-10 gap-1">
      ...
      <div class="sm:col-span-7 p-5">
        ...
        <div class="text-black dark:text-sky-400 text-sm mt-4 mb-4 md:flex md:space-x-6">
          <div class="flex items-center">
            <LogoDate />
            <p> {{ date }}</p>
          </div>
        </div>
        <div class="text-black dark:text-zinc-300 text-sm mt-2 mb-2 md:flex md:space-x-6">
        ...
        <div class="flex group-hover:underline text-sky-700 dark:text-sky-400 items-center pt-2 transition-colors duration-300">
          <p>Leer más</p>
          <LogoArrow />
        </div>
      </div>
