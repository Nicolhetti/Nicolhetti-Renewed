...
export const aboutPage = {
  ...
  Y muchas gracias a <a href="https://github.com/goodendinggg" class="font-bold transition duration-300"><span class="px-3 animate-shine">goodendinggg</span></a> por la ayuda con la web 👌`,
}
